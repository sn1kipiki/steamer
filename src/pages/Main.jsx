    ...
    <div>
      ...
      <div className="photo-slider-box">
                ...
                <Carousel  interval="1000" transitionTime="1000" infiniteLoop>
                    <div>
                        <img src={Img_2} alt="" />
                        <button onClick={navigationHandler} className='legend'>Оформити замовлення</button>
                    </div>
                    <div>
                        <img src={Img_3} alt="" />
                        <button onClick={navigationHandler} className='legend'>Оформити замовлення</button>
      ...
      <div className="content">
        ...
        <button onClick={navigationHandler} className='content_button'>Оформити замовлення</button>
